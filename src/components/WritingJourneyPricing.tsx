  ...
  const journeys = [
    {
      ...
      features: [
        ...
        "5 AI detections/month (GPTZero + Copyleaks + ZeroGPT APIs)",
    ...
    },
    {
      ...
      features: [
        ...
        "50 AI detections/month (GPTZero + Copyleaks + ZeroGPT APIs)",
        "All 6 tone personalities",
    ...
    },
    {
      ...
      features: [
        ...
        "100 AI detections/month (GPTZero + Copyleaks + ZeroGPT APIs)",
        "All 6 tone personalities",
